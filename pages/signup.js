    ...
    <div className='bg-secondary h-screen w-full relative p-2'>
        <div className='max-w-xl min-w-fit mx-auto mt-24 py-10 flex flex-col bg-slate-300/40 z-10 shadow-xl rounded-lg items-center'>
            ...
            <div className='my-3 mx-3'>
              <input className=' border-2 border-primaryDark rounded-xl px-3 py-2 active:border-2' name='name' placeholder='Full Name' type='name'/>
            </div>
            ...
            <div className='my-3 mx-3'>
              <input className='form-input border-2 border-primaryDark rounded-xl px-3 py-2' name='password' placeholder='Confirm Password' type='password'/>
            </div>

            <div className='my-2 mx-10 text-white'>Already a user? <Link href="/login"><span className='text-blue-500 hover:underline cursor-pointer'>Login</span></Link></div>
